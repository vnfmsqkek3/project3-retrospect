const serverless = require('serverless-http'); //create
    ...
    function (error, results, fields) {
      ...
      if (results[0].stock > 0) {
        ...
        let params = {
          ...
          TopicArn: "arn:aws:sns:ap-northeast-2:485879423137:stock_empty"
        };
...
/**
 curl --location --request POST 'https://wo6usunjkh.execute-api.ap-northeast-2.amazonaws.com/send' \
...
module.exports.handler = serverless(app); //create